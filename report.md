...
available for a business. Cinemas are places of great affluence, and choosing
the right business close to a cinema could be very lucrative. But how to choose
which type of commerce would be best? A café? A restaurant? Which type?

The stakeholders of Cinema Guzzo want a report on what type of commerce works
well around other cinemas in the cities so that they can start one of the same
type in the mall. There would be even more chances of success if it is a
commerce type lacking in the current mall.

For example, if most cinemas in Montreal has multiple cafés nearby and the
...
businesses in a given location. The location will come from the previous
`search` query.
...
visualisations will allow us to identify the most popular type of commerce
around cinemas. By comparing these results with the type of commerce around the
